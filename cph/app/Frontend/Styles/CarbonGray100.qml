...
QtObject {
    ...
    readonly property color green40: "#42be65"
    ...
    // support
    readonly property color supportError: red50
    readonly property color supportSuccess: green40

    // miscellaneos
    readonly property color toggleOff: gray60
